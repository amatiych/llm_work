"""AI-powered report generation — uses Claude to analyze data and write commentary."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate AI-powered investment reports (uses Claude API)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Save raw LLM commentary to a JSON file for inspection",
    )
